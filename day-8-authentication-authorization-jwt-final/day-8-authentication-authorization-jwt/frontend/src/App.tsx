    ...
    >
      ...
      {view !== "dashboard" ? (
        <div style={card}>
            ...
            {(["login", "register"] as AuthView[]).map((v) => (
              <button
                ...
                style={{
                  ...
                  background: "none",
                  borderBottom:
                    view === v ? "2px solid #4299e1" : "2px solid transparent",
                  color: view === v ? "#4299e1" : "#718096",
                  fontWeight: 600,
                  cursor: "pointer",
          ...
          >
            <strong>Demo credentials:</strong> alice@test.com / Password1
            <br />
        ...
        <div style={{ ...card, maxWidth: 600 }}>
          ...
          >
            <strong>Access Token (in memory, not localStorage!):</strong>
            <br />
          ...
          >
            {[
              ...
              <button
                key={path}
                onClick={async () =>
                  setApiResult(await callProtectedRoute(path))
                }
                style={{
                  padding: "6px 14px",
                  borderRadius: 6,
