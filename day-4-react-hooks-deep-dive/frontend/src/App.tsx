...
export default function App() {
  ...
  const fetchResults = useCallback(async () => {
    ...
    const res = await fetch(
      `http://localhost:3001/api/search?q=${debouncedSearch}`,
    );
    ...
    >
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        ...
        <p style={{ color: "#718096", marginBottom: 20 }}>
          Theme saved to localStorage — refresh the page, it persists!
        </p>
        ...
        <div
          style={{
            ...card,
            background: metrics.isSlow ? "#fff5f5" : card.background,
        ...
        >
          ...
          >
            {[
              ...
              >
                <div
                  style={{ fontSize: 22, fontWeight: 700, color: "#4299e1" }}
                >
                  {value}
                </div>
        ...
        <div style={card}>
          <h3 style={{ marginTop: 0 }}>
            🔍 useDebounce — Search (500ms delay)
          </h3>
          <input
            value={searchInput}
          ...
          <div style={{ marginTop: 8, fontSize: 13 }}>
            <div>
              Raw input: <strong>"{searchInput}"</strong>
            </div>
            <div>
              Debounced (API fires here):{" "}
              <strong style={{ color: "#4299e1" }}>"{debouncedSearch}"</strong>
            </div>
            <div style={{ marginTop: 4 }}>
              ...
              <span
                style={{
                  color:
                    searchState.status === "loading" ? "#ed8936" : "#48bb78",
                }}
              >
                {searchState.status}
              </span>
        ...
        <div style={card}>
          <h3 style={{ marginTop: 0 }}>
            🏎️ useThrottle — Mouse Position (200ms)
          </h3>
          <p style={{ fontSize: 13, color: "#718096", margin: "0 0 8px" }}>
            Move your mouse over the page. Throttled value updates max once per
            200ms.
          </p>
          <div style={{ display: "flex", gap: 20, fontSize: 14 }}>
            <div>
              Raw X: <strong>{mouseX}px</strong>
            </div>
            <div>
              Throttled X:{" "}
              <strong style={{ color: "#9f7aea" }}>{throttledMouseX}px</strong>
            </div>
          </div>
        </div>
        ...
        <div style={card}>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <div style={{ textAlign: "center", minWidth: 100 }}>
              ...
              <div style={{ fontSize: 24, fontWeight: 700, color: "#4299e1" }}>
                {counter}
              </div>
        ...
        <div style={card}>
          <h3 style={{ marginTop: 0 }}>
            🔄 useReducer — Bounded Counter (min: {counterState.min}, max:{" "}
            {counterState.max})
          </h3>
          <div
            style={{
        ...
        <div style={card}>
          ...
          {savedName && (
            <p style={{ marginTop: 8, fontSize: 14 }}>
              👋 Hello, <strong>{savedName}</strong>! (Stored in localStorage
              key: "userName")
            </p>
          )}
